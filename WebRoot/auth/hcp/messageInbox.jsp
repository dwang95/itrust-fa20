		...
		if(request.getParameter("cancel") != null) 
			...
			if(!error) {
				if(request.getParameter("test") != null) {
				    ...
				    PersonnelBean pb = dao.getPersonnel(loggedInMID.longValue());
					f_action.editMessageFilter(nf,pb);
...
<%		int index = 0; 
		...
		<tr style="font-weight: bold;" <%=(index%2 == 1)?"class=\"alt\"":"" %>>
			...
			<td><a href="..\hcp-patient\viewMessageInbox.jsp?msg=<%= StringEscapeUtils.escapeHtml("" + ( index )) %>">Read</a></td>
		</tr>
<% 			   } else { %>
