<div class="panel panel-default">
	...
	<div class="panel-body" id="info-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp-uap/viewPreRegisteredPatients.jsp">View Pre-Registered Patients</a>
...
<div class="panel panel-default">
	...
	<div class="panel-body" id="other-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp/viewCauseOfDeathTrends.jsp">Cause of Death Reports</a>	
		</ul>
	</div>
</div>